...
class FornecedorListAdapter(private val onStatusChange: (FornecedorModel) -> Unit,
                            private val onEditChange: (FornecedorModel, String?) -> Unit,
                            private val sendToWhatsapp: (FornecedorModel) -> Unit): RecyclerView.Adapter<FornecedorViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FornecedorViewHolder {
        ...
        return FornecedorViewHolder(binding, onStatusChange, onEditChange, sendToWhatsapp)
    }
